...
INCLUDES =           # A list of -I Include directories to be added to the
                     # the compile command.
INCLUDES = -I$(SMARTREDIS_INSTALL_PATH)/include -L$(SMARTREDIS_INSTALL_PATH)/lib -I/home/dongw/smartredis/include -L/home/dongw/smartredis/build -lsmartredis -I/home/dongw/software/netcdf-fortran/include -L/home/dongw/software/netcdf-fortran/lib -lnetcdf -lnetcdff -L/home/dongw/NCAR_ML_EKE/MOM6/build/gnu/shared/repro -lfms
